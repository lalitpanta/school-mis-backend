...
router.post(
  "/groups",
  requirePermission("fees.manage"),
  feeController.createGroup,
);

// Structures
router.get("/structures", feeController.getStructures);
router.get("/managed-structures", feeController.getStructures);
router.post(
  "/structures",
  requirePermission("fees.manage"),
...
router.post(
  "/managed-structures",
  requirePermission("fees.manage"),
  feeController.createManagedStructure,
);
router.put(
  "/managed-structures/:id",
  requirePermission("fees.manage"),
  feeController.updateManagedStructure,
);
router.patch(
  "/managed-structures/:id/status",
  requirePermission("fees.manage"),
  feeController.setStructureStatus,
);
router.post(
  "/managed-structures/:id/duplicate",
  requirePermission("fees.manage"),
  feeController.duplicateStructure,
);
router.post(
  "/assignments",
  requirePermission("fees.manage"),
  feeController.assignStructure,
);
...
router.post(
  "/students/:studentId/generate-due",
  requirePermission("fees.manage"),
  feeController.generateStudentDue,
);
...
router.post(
  ...
  requirePermission("fees.manage"),
  feeController.bulkGenerateStudentFees,
);
...
router.post(
  "/receipts/:id/cancellation",
  requirePermission("fees.collect"),
  feeController.requestReceiptCancellation,
);
router.patch(
  "/receipts/:id/cancellation/approve",
  requirePermission("fees.manage"),
  feeController.approveReceiptCancellation,
);
...
router.post(
  ...
  requirePermission("fees.collect"),
  feeController.recordInvoicePayment,
);
